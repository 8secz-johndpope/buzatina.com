...
/*app.get('/profile/:profileid', function(req, res){
  ...
  getFollowers(req.params.profileid);
	...
	AWS.config.accessKeyId = "AKIAJK73SBPFOJRJ2KRQ";
	AWS.config.secretAccessKey = "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";
        ...
        docClient.get(params, function(err, data){
            if (err) {
              ...
              emitProfile(data.Item);
            	//io.sockets.emit('profile', data.Item);
              //getU
...
//        content = new helper.Content("text/plain", data[i].advisor + " shared new advice");        
      	...
      	var sg = require('sendgrid')('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');
      ...
      // Generate Random Number
       ...
       var bucket = new AWS.S3({
        ...
        if (file) {
            ...
            var objKey = 'ProfilePic/' + file.name;
